...
function float_to_bin(float) {
    ...
    return rigth_to_bin(right) + '.' + left_to_bin(left);

}

//float = 23.5
number = require('prompt-sync')();
console.log(float_to_bin(number));
